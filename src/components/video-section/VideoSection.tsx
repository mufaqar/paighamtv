...
import { VideosData } from '../../../public/data'
          ...
          <section className="bg-primary py-20">
               <div className='container mx-auto px-4'>
                    ...
                    <div className='grid grid-cols-2 lg:grid-cols-4 mt-10 gap-4'>
                         {
                              VideosData.map((item, idx: number) => (
                                   <div className='bg-red-300 relative group overflow-hidden' key={idx}>
                                        ...
                                        <div className='bg-gradient-to-t from-black via-black/50 absolute inset-0 p-3 md:p-6 flex flex-col justify-end font-metapro to-black/0'>
                                             ...
                                             <button onClick={() => OpenVideo(getVideoCode(item.videolink))} className='bg-secondary opacity-75 hover:scale-105 p-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10'>
                                                  <PiPlay size={28} />
                                             </button>
                                        </div>
                                   </div>
