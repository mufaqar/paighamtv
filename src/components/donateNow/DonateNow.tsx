...
const DonateNow = () => {
  return (
    <section className='bg-[url("/images/donate-now.png")] bg-cover bg-no-repeat py-32'>
       <div className='container mx-auto px-4'>
       <h2 className='font-metapro text-white text-5xl max-w-[600px] leading-[60px] tracking-widest font-semibold'>The Easy Way To Donate To Good Causes</h2>
