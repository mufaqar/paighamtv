...
const LeftSideBar = ({ setLeftSideBar, leftSidebar }: any) => {
  return (
    <section className={`bg-primary text-white fixed max-w-[350px] w-full z-10 top-0 transition-all duration-300 ease-in-out h-full ${leftSidebar ? 'left-0' : '-left-full'}`}>
      <div className=' h-full w-full flex flex-col items-center relative p-8'>
        ...
        <iframe className="mt-8" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13592.604137323078!2d74.300666!3d31.602321!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39191c7c0a71319d%3A0x4217b592e2f4ea1c!2sSuccess%20Designers!5e0!3m2!1sen!2sus!4v1689244313056!5m2!1sen!2sus" width="280" height="200" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </section>
  )
}
