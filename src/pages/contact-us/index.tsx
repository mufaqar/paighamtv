        ...
        <>
            ...
            <section className='container mx-auto mb-28 px-4'>
                ...
                <div className=' justify-between items-center mt-20 mb-10  '>
                    <h2 className='font-metapro text-3xl md:text-5xl text-darkgray font-bold border-b-[3px] border-darkgray  pb-5'> Main Office</h2>
                    <div className='pt-6'>

                        <p> <strong> Address : </strong> 106 Ravi Road‏, Lahore, Pakistan</p>

                        <p> <strong>Call Us : </strong>   0092-42-37722876</p>

                        <p> <strong>  Email :  </strong>   info.paigham@gmail.com</p>
